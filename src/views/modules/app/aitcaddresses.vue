  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('app:aitcaddresses:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('app:aitcaddresses:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <!--  <el-table-column  prop="id"  header-align="center"  align="center"  label="主键">
        ...
        <el-table-column  prop="number"  header-align="center"  align="center"  label="资产">
        </el-table-column>
        <el-table-column  prop="node"  header-align="center"  align="center"  label="生成节点名">
        </el-table-column>
...
<script>
  import AddOrUpdate from './aitcaddresses-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/app/aitcaddresses/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/app/aitcaddresses/delete'),
            method: 'post',
